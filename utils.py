...
from project_data import Shop, Store, Request, MessageError
from project_data.exceptions import StorageFullError, ItemsNotFoundError
...
def send_request(user_task: str, shop: Shop, store: Store) -> str:
    ...
    except (MessageError, StorageFullError, ItemsNotFoundError) as e:
        print(e)
